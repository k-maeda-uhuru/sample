...
1. https://dashboard.heroku.com/apps/uhuru-backend-dev にログインしてからOverviewタブのHeroku Postgresアイコンを押す。
    ![heroku_postgres](https://drive.google.com/a/sub-uhuru.jp/file/d/0BwlPRO9stTavaFZBVFJWdXlnS1k/view?usp=sharing)
...
#### front-endの準備っぽい事
1. front-endでnpm installする
    ```
    cd /home/vagrant/sato/sato-sos-front-end/
    sudo npm install
    ```
...
- back-end
    ```
    cd /home/vagrant/sato/sato-sos-back-end
...
#### 起動後の確認
- back-end
    - ブラウザで`http://192.168.33.10:9292`にアクセス

- front-end
    - ブラウザで`http://192.168.33.10:1337`にアクセス
    - 備考
